    ...
    <Modal :mdShow="addMdShow" @close="closeModal">
      <div slot="message">
        <ul class="addressUl">
          <li>
            <span>姓名：</span>
            <input type="text" v-model="addressObj.userName" name="userName">
          </li>
          <li>
            <span>电话：</span>
            <input type="text" v-model="addressObj.tel" name="tel">
          </li>
          <li>
            <span>邮编：</span>
            <input type="text" v-model="addressObj.postCode" name="postCode">
          </li>
          <li>
            <span>地址：</span>
            <input type="text" v-model="addressObj.streetName" name="streetName">
          </li>
        </ul>
      </div>
      <div slot="btnGroup">
        <a href="javascript:;" class="btn btn-m" @click="confirmAddAddress">确定</a>
        <a href="javascript:;" class="btn btn-m" @click="addMdShow=false">取消</a>
      </div>
    </Modal>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    confirmAddAddress() {
      axios
        .post("/users/addAddress", { addressObj: this.addressObj })
        .then(res => {
          let data = res.data;
          if (data.status === "0") {
            this.addMdShow = false;
